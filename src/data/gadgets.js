...
export const GADGETS = {
  ...
  proximity_mine: { id: 'proximity_mine', label: 'Proximity Alarm',        icon: I('game_r6_gadget_proximitymine_966fd.webp'),             category: 'utility', count: 2 },
  ...
  barricade:      { id: 'barricade',      label: 'Barricade',              icon: I('game_r6_gadget_barricade_74tfb3.webp'),                category: 'utility', count: 3, placement: 'opening' },
  ...
  trip_wire:      { id: 'trip_wire',      label: 'T.R.I.P. Connector',     icon: I('game_r6_gadget_trip_connector_white_7456f.webp'),      category: 'defend', count: 7 },
  ...
  fuze_charge:    { id: 'fuze_charge',    label: 'APM-6 Cluster Charge',   icon: I('game_r6_cluster__charge_ugh54.webp'),                  category: 'attack', count: 3 },
  capitao_bow:    { id: 'capitao_bow',    label: 'Tactical Crossbow',      icon: I('game_r6_capitao_firebolt_pofk4.webp'),                 category: 'attack', count: 4 },
  ying_candela:   { id: 'ying_candela',   label: 'Candela',                icon: I('game_r6_gadget_candela_invert_NuDgmVdePG.webp'),       category: 'attack', count: 3 },
  nomad_airjab:   { id: 'nomad_airjab',   label: 'Airjab Launcher',        icon: I('game_r6_gadget_nomad_cae9d.webp'),                     category: 'attack', count: 3 },
  gridlock_trax:  { id: 'gridlock_trax',  label: 'Trax Stinger',           icon: I('game_r6_ability_trax_stingers_fyBlqEOxjW.webp'),       category: 'attack', count: 3 },
  ...
  zero_argus:     { id: 'zero_argus',     label: 'Argus Camera',           icon: I('game_r6_gadget_zero_9a2a9.webp'),                      category: 'attack', count: 3 },
  ...
  goyo_volcan:    { id: 'goyo_volcan',    label: 'Volcán Canister',        icon: I('game_r6_gadget_goyo_canister_2PB84eNdAJ.webp'),        category: 'defend', count: 4 },
  wamai_magnet:   { id: 'wamai_magnet',   label: 'Mag-NET System',         icon: I('game_r6_gadget_wamai_e4f89.webp'),                     category: 'defend', count: 6 },
  melusi_banshee: { id: 'melusi_banshee', label: 'Banshee Sonic Defense',  icon: I('game_r6_gadget_melusibanshee_98baf.webp'),             category: 'defend', count: 4 },
  aruni_gate:     { id: 'aruni_gate',     label: 'Surya Gate',             icon: I('game_r6_gadget_arunigate_245c3.webp'),                 category: 'defend', count: 3, placement: 'opening', markerTypes: ['wall', 'softwall', 'door', 'window', 'hatch'] },
  ...
  fenrir_dread:   { id: 'fenrir_dread',   label: 'F-NATT Dread Mine',      icon: I('game_r6_f_natt_spaxr.webp'),                           category: 'defend', count: 4 },
  ...
  mira_mirror:    { id: 'mira_mirror',    label: 'Black Mirror (Mira Window)', icon: I('game_r6_gadget_mira_fe9df.webp'),                   category: 'defend', count: 2, placement: 'wall', markerTypes: ['wall', 'softwall'] },
